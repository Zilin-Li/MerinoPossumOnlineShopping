from ..models.admin_manage_credit_model import get_credit_info_from_db, insert_credit_limit_increase_request, update_credit_limit, fetch_all_clients, fetch_credit_limit_increase_requests, approve_credit_limit_request
...
def adjust_credit_limit(user_id, new_limit, admin_id):
